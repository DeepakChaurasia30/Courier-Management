...
public class ClientService {
    ...
    public ClientDTO updateClient(Integer clientId, ClientDTO dto) {
        ...
        client.setClientAdd(dto.getClientAdd().toUpperCase());
        client.setClientPin(dto.getClientPin());
        client.setClientGstin(dto.getClientGstin().toUpperCase());
        client.setClientIsgst(dto.getClientIsgst());
        client.setTaxRate(dto.getTaxRate());
        client.setState(state);

        client.setTagLine(dto.getTagLine().toUpperCase());
        client.setSacCode(dto.getSacCode());
        client.setContNo(dto.getContNo());
        client.setContMail(dto.getContMail());

        client.setBName(dto.getBName().toUpperCase());
        client.setBAcc(dto.getBAcc());
        client.setBIfsc(dto.getBIfsc().toUpperCase());

        client.setCompPan(dto.getCompPan().toUpperCase());
        client.setCompMsme(dto.getCompMsme().toUpperCase());
