...
import com.courier.management.projection.InvoiceTableProjection;
...
public class InvoiceServices {
        ...
        public List<InvoiceTableProjection> findTop50ByClientId(Integer clientID)
        {
             List<InvoiceTableProjection> list = invoiceRepository.findTop50ByClientidOrderByInvDateDesc(clientID);
